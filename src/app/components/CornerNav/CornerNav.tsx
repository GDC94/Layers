  ...
  return (
    <>
      <motion.div
        ...
        className="fixed z-10 rounded-xl bg-gradient-to-br from-violet-700 to-violet-500 shadow-lg shadow-violet-800/20"
      />
  ...
  return (
    <>
      ...
      <motion.button
        ...
        exit={{ opacity: 0, y: 8 }}
        className="absolute bottom-2 right-2 flex items-center gap-2 rounded-full bg-black px-3 py-3 text-4xl uppercase text-white transition-colors hover:bg-white hover:text-violet-600 md:bottom-4 md:right-4 md:px-6 md:text-2xl"
      >
